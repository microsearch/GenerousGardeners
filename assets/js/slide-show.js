function fadeSlideShow(a) {
    ...
    b.each(function() {
      if (this.nodeName === (a[c] && a[c].nodeName)) {
        ...
        if (b = b && b.events) {
          ...
          d.events = {};
          for (var e in b)
            for (var f in b[e]) q.event.add(this, e, b[e][f], b[e][f].data)
        }
      }
    })
  }
  ...
  q.extend({
    ...
    globalEval: function(a) {
      if (a && x.test(a)) {
        ...
        if (q.support.scriptEval) c.appendChild(t.createTextNode(a));
        else c.text = a;
          ...
          for (e in a) {
            ...
            for (; f < g;) {
              ...
              for (e in a) {
                ...
                for (d = a[0]; f < g && c.call(d, f, d) !== false; d = a[++f]);
      return a
    },
    trim: function(a) {
      return (a || "").replace(y, "")
    ...
    removeData: function(b, c) {
      if (!(b.nodeName && q.noData[b.nodeName.toLowerCase()])) {
        ...
        if (c) {
          ...
          if (q.support.deleteExpando) delete b[q.expando];
  ...
  q.extend({
    queue: function(a, b, c) {
      if (a) {
        ...
        var d = q.data(a, b);
        if (!c) return d || [];
        if (!d || q.isArray(c)) d = q.data(a, b, q.makeArray(c));
        else d.push(c);
        return d
      }
    },
  ...
  q.fn.extend({
    ...
    addClass: function(a) {
      ...
      if (a && typeof a === "string")
        for (var b = (a || "").split(N), c = 0, d = this.length; c < d; c++) {
          var e = this[c];
          if (e.nodeType === 1)
            if (e.className) {
              for (var f = " " + e.className + " ", g = e.className, h = 0, i = b.length; h < i; h++)
                if (f.indexOf(" " + b[h] + " ") < 0) g += " " + b[h];
    ...
    removeClass: function(a) {
      ...
      if (a && typeof a === "string" || a === b)
        for (var c = (a || "").split(N), d = 0, e = this.length; d < e; d++) {
          var f = this[d];
    ...
    toggleClass: function(a, b) {
      ...
      return this.each(function() {
        if (c === "string")
          for (var e, f = 0, g = q(this), h = b, i = a.split(N); e = i[f++];) {
            h = d ? h : !g.hasClass(e);
    ...
    hasClass: function(a) {
      ...
      for (var b = 0, c = this.length; b < c; b++)
        if ((" " + this[b].className + " ").replace(M, " ").indexOf(a) > -1) return true;
      return false
    },
    val: function(a) {
      if (a === b) {
      ...
      if (!(c.nodeType === 3 || c.nodeType === 8)) {
        ...
        if (h = q.data(c)) {
          ...
          for (var k, l = 0, m; k = d[l++];) {
            ...
            if (!n) {
              n = i[k] = [];
              if (!o.setup || o.setup.call(c, f, m, j) === false)
                if (c.addEventListener) c.addEventListener(k, j, false);
                else c.attachEvent && c.attachEvent("on" + k, j)
            }
            if (o.add) {
              o.add.call(c, h);
  ...
  a.attachEvent && !a.addEventListener && a.attachEvent("onunload", function() {
    for (var a in q.cache)
      if (q.cache[a].handle) try {
  ...
  (function() {
    ...
    var j = function(a, b, c, d) {
      ...
      for (var h = [], i, m, o, p, q = true, v = s(b), w = a;
      ...
      if (h.length > 1 && l.exec(a))
        if (h.length === 2 && k.relative[h[0]]) m = u(h[0] + h[1], b);
        else
          for (m = k.relative[h[0]] ? [b] : j(h.shift(), b); h.length;) {
            a = h.shift();
      ...
      o || (o = m);
      o || j.error(x || a);
      if (g.call(o) === "[object Array]")
        if (q)
          if (b && b.nodeType === 1)
            for (a = 0; o[a] != null; a++) {
              if (o[a] && (o[a] === true || o[a].nodeType === 1 && r(b, o[a]))) c.push(m[a])
            } else
              for (a = 0; o[a] != null; a++) o[a] && o[a].nodeType === 1 && c.push(m[a]);
        ...
        for (var n in k.filter)
          if ((i = k.leftMatch[n].exec(a)) != null && i[2]) {
            ...
            if (q.substr(q.length - 1) !== "\\") {
              if (h === g) g = [];
              if (k.preFilter[n])
                if (i = k.preFilter[n](i, h, d, g, e, m)) {
                  if (i === true) continue
                } else l = p = true;
              if (i)
                for (var r = 0;
    ...
    var k = j.selectors = {
          ...
          ">": function(a, b) {
            ...
            if (c && !/\W/.test(b)) {
              ...
              for (e = a.length; d < e; d++)
                if (f = a[d]) a[d] = c ? f.parentNode : f.parentNode === b;
              c && j.filter(b, a, true)
            }
          },
          "": function(a, b, e) {
        ...
        preFilter: {
          ...
          PSEUDO: function(a, b, c, d, f) {
            if (a[1] === "not")
              if ((e.exec(a[3]) || "").length > 1 || /^\w/.test(a[3])) a[3] = j(a[3], null, null, b);
              else {
    ...
    has: function(a) {
      ...
      return this.filter(function() {
        for (var a = 0, c = b.length; a < c; a++)
          if (q.contains(this, b[a])) return true
      })
    },
    not: function(a) {
  ...
  q.fn.extend({
    ...
    empty: function() {
      for (var a = 0, b;
        (b = this[a]) != null; a++)
        for (b.nodeType === 1 && q.cleanData(b.getElementsByTagName("*")); b.firstChild;) b.removeChild(b.firstChild);
      return this
    },
    clone: function(a) {
  ...
  q.extend({
    clean: function(a, b, c, d) {
      ...
      if (c)
        for (f = 0; e[f]; f++)
          if (d && q.nodeName(e[f], "script") && (!e[f].type || e[f].type.toLowerCase() === "text/javascript")) d.push(e[f].parentNode ? e[f].parentNode.removeChild(e[f]) : e[f]);
          else {
    ...
    cleanData: function(a) {
      for (var b, c, d = q.cache, e = q.event.special, f = q.support.deleteExpando, g = 0, h;
        ...
        if (c = h[q.expando]) {
          b = d[c];
          if (b.events)
            for (var i in b.events) e[i] ? q.event.remove(h, i) : W(h, i, b.handle);
          if (f) delete h[q.expando];
          else h.removeAttribute && h.removeAttribute(q.expando);
          delete d[c]
        }
    }
  });
      ...
      if (b === "width" || b === "height") {
        ...
        function g() {
          ...
          d !== "border" && q.each(f, function() {
            ...
            if (d === "margin") e += parseFloat(q.curCSS(a, "margin" + this, true)) || 0;
            else e -= parseFloat(q.curCSS(a, "border" + this + "Width", true)) || 0
          })
        }
  ...
  q.extend({
    ...
    ajax: function(c) {
      ...
      var h = q.extend(true, {}, q.ajaxSettings, c),
      ...
      if (v) {
        ...
        var x = v.onreadystatechange = function(a) {
          if (!v || v.readyState === 0 || a === "abort") {
            ...
            if (j === "success" || j === "notmodified") i || d();
            else q.handleError(h, v, j, b);
            e();
            a === "timeout" && v.abort();
            if (h.async) v = null
          }
    ...
    httpData: function(a, b, c) {
      ...
      if (typeof a === "string")
        if (b === "json" || !b && d.indexOf("json") >= 0) a = q.parseJSON(a);
  ...
  q.fn.extend({
    ...
    toggle: function(a, b) {
      ...
      if (q.isFunction(a) && q.isFunction(b)) this._toggle.apply(this, arguments);
      else a == null || c ? this.each(function() {
    ...
    step: function(a) {
      ...
      if (a || b >= this.options.duration + this.startTime) {
        ...
        for (var d in this.options.curAnim)
          if (this.options.curAnim[d] !== true) c = false;
        if (c) {
          ...
          if (this.options.hide || this.options.show)
            for (var e in this.options.curAnim) q.style(this.elem, e, this.options.orig[e]);
  ...
  q.offset = {
    initialize: function() {
      var a = t.body,
        b = t.createElement("div"),
        c, d, e, f = parseFloat(q.curCSS(a, "marginTop", true)) || 0;
      q.extend(b.style, {
        position: "absolute",
        top: 0,
        left: 0,
    ...
    setOffset: function(a, b, c) {
      ...
      var d = q(a),
        e = d.offset(),
        f = parseInt(q.curCSS(a, "top", true), 10) || 0,
        g = parseInt(q.curCSS(a, "left", true), 10) || 0;
  ...
  q.each(["Left", "Top"], function(a, c) {
    ...
    q.fn[d] = function(c) {
      ...
      if (c !== b) return this.each(function() {
        if (f = p(this)) f.scrollTo(!a ? c : q(f).scrollLeft(), a ? c : q(f).scrollTop());
        else this[d] = c
      });
